...
public enum ChessPiece2 {
    ...
    private String representationOfFigure;

    ChessPiece2(double valueOfFigure, String representationOfFigure) {
        this.valueOfFigure = valueOfFigure;
        this.representationOfFigure = representationOfFigure;
    }
    ...
    public String getRepresentationOfFigure() {

        return representationOfFigure;
    }
}
